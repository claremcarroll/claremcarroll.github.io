    ...
    public function getElementsModal() {
        ...
        <div class="modal wpb-elements-list-modal">
          <div class="modal-header">
                <a class="close" href="#" data-dismiss="modal"><i class="font-icon-cross"></i></a>
            ...
            <div id="wpb_visual_composer-elements" class="vc_navbar">
                ...
                <div class="vc_navbar-inner clearfix">
                    <!--<div class="container">-->
                            ...
                            <ul class="vc_nav">
                              <li>
                                <a class="wpb_add_new_row dropable_row button" id="wpb-add-new-row" data-element="vc_row"><i class="icon"></i>'.__('Add Section', 'js_composer').'</a>
                                </li>
                            </ul>
