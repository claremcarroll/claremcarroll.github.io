...
class WPBakeryShortCode_AZ_Portfolio_Grid extends WPBakeryShortCode {
  protected function content($atts, $content = null) {
    $portfolio_layout = $portfolio_wall = $link_portfolio_item = $portfolio_columns_count = $animation_loading = $animation_loading_effects = $portfolio_post_number = $portfolio_post_link = $portfolio_sortable_name = $portfolio_sortable_mode = $portfolio_categories = $orderby = $order = $el_class = '';
