...
function wr_corsa_setup() {
	...
	/**
	 * Set crop image blog page
	 *
	 * @link https://codex.wordpress.org/Function_Reference/add_image_size
	 */
	add_image_size( 'blog_thumbnail', 570, 360, true ); // (cropped)
...
function wr_corsa_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'primary-sidebar',
		'description'   => __( 'This is the primary sidebar if you are using a two or three column site layout option.', 'corsa' ),
	...
	register_sidebar( array(
		...
		'description'   => __( 'This is the secondary sidebar if you are using a two or three column site layout option.', 'corsa' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		...
		'id'            => 'bottom-1',
		'description'   => __( 'The first column in bottom area', 'corsa' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		...
		'id'            => 'bottom-2',
		'description'   => __( 'The second column in bottom area', 'corsa' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		...
		'id'            => 'bottom-3',
		'description'   => __( 'The third column in bottom area', 'corsa' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		'name'          => __( 'Bottom 4', 'corsa' ),
		'id'            => 'bottom-4',
		'description'   => __( 'The four column in bottom area', 'corsa' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
 ...
 * @since 1.1
 */
function wr_corsa_add_menu() {
	add_theme_page( 'About Corsa', 'About Corsa', 'manage_options', 'corsa-home', 'wr_corsa_welcome' );
}
add_action( 'admin_menu', 'wr_corsa_add_menu' );
...
function wr_corsa_scripts() {
	...
	wp_enqueue_style( 'corsa-stylesheet', get_stylesheet_uri() );

	// Load font awesome stylesheet.
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/assets/css/vendor/font-awesome.css' );
	...
	wp_enqueue_style( 'corsa-custom', get_template_directory_uri() . '/assets/css/custom.css', array( 'dashicons' ) );
	...
	// Load image preview javascript
	wp_register_script( 'image-preview-script', get_template_directory_uri() . '/assets/js/image-preview.js', array( ), '', true );
