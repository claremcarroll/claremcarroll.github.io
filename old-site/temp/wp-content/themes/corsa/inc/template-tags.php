			...
			default :
				...
				<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
					<article id="comment-<?php comment_ID(); ?>" class="comment-body">
						...
						<footer class="comment-footer cl">
							<div class="comment-time">
								...
								printf(
									...
									get_comment_time( 'c' ),
									sprintf( __( '%1$s at %2$s', 'corsa' ), get_comment_date("j - M - y"), get_comment_time() )
								);
								?>
							</div>
							...
							<div class="action-link">
								...
								comment_reply_link(
									array_merge(
										$args,
										array(
											'reply_text' => __( '<span><i class="fa fa-reply"></i> Reply</span>', 'corsa' ),
											'depth'      => $depth,
