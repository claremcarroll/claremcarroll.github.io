...
class Authentic_Portfolio_Post_Type {
	...
	function portfolio_init() {
		...
		$taxonomy_portfolio_tag_labels = array(
			'name' => _x( 'Portfolio Tags', 'att' ),
			'singular_name' => _x( 'Portfolio Tag', 'att' ),
			'search_items' => _x( 'Search Portfolio Tags', 'att' ),
			'popular_items' => _x( 'Popular Portfolio Tags', 'att' ),
			'all_items' => _x( 'All Portfolio Tags', 'att' ),
			'parent_item' => _x( 'Parent Portfolio Tag', 'att' ),
			'parent_item_colon' => _x( 'Parent Portfolio Tag:', 'att' ),
			'edit_item' => _x( 'Edit Portfolio Tag', 'att' ),
			'update_item' => _x( 'Update Portfolio Tag', 'att' ),
			'add_new_item' => _x( 'Add New Portfolio Tag', 'att' ),
			'new_item_name' => _x( 'New Portfolio Tag Name', 'att' ),
			'separate_items_with_commas' => _x( 'Separate portfolio tags with commas', 'att' ),
			'add_or_remove_items' => _x( 'Add or remove portfolio tags', 'att' ),
			'choose_from_most_used' => _x( 'Choose from the most used portfolio tags', 'att' ),
			'menu_name' => _x( 'Portfolio Tags', 'att' )
		);
	    ...
	    $taxonomy_portfolio_category_labels = array(
			'name' => _x( 'Portfolio Categories', 'att' ),
			'singular_name' => _x( 'Portfolio Category', 'att' ),
			'search_items' => _x( 'Search Portfolio Categories', 'att' ),
			'popular_items' => _x( 'Popular Portfolio Categories', 'att' ),
			'all_items' => _x( 'All Portfolio Categories', 'att' ),
			'parent_item' => _x( 'Parent Portfolio Category', 'att' ),
			'parent_item_colon' => _x( 'Parent Portfolio Category:', 'att' ),
			'edit_item' => _x( 'Edit Portfolio Category', 'att' ),
			'update_item' => _x( 'Update Portfolio Category', 'att' ),
			'add_new_item' => _x( 'Add New Portfolio Category', 'att' ),
			'new_item_name' => _x( 'New Portfolio Category Name', 'att' ),
			'separate_items_with_commas' => _x( 'Separate portfolio categories with commas', 'att' ),
			'add_or_remove_items' => _x( 'Add or remove portfolio categories', 'att' ),
			'choose_from_most_used' => _x( 'Choose from the most used portfolio categories', 'att' ),
			'menu_name' => _x( 'Portfolio Categories', 'att' ),
	    );
...
new Authentic_Portfolio_Post_Type;
