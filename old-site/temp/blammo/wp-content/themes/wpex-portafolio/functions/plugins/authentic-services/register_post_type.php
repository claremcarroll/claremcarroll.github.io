...
if ( ! class_exists( 'Authentic_Services_Post_Type' ) ) :
class Authentic_Services_Post_Type {
	...
	function __construct() {
		...
		load_plugin_textdomain( 'att', false, dirname( plugin_basename( __FILE__ ) ) . '/lang/' );
	...
	function services_init() {
		...
		$taxonomy_services_tag_labels = array(
			'name' => _x( 'Services Tags', 'att' ),
			'singular_name' => _x( 'Services Tag', 'att' ),
			'search_items' => _x( 'Search Services Tags', 'att' ),
			'popular_items' => _x( 'Popular Services Tags', 'att' ),
			'all_items' => _x( 'All Services Tags', 'att' ),
			'parent_item' => _x( 'Parent Services Tag', 'att' ),
			'parent_item_colon' => _x( 'Parent Services Tag:', 'att' ),
			'edit_item' => _x( 'Edit Services Tag', 'att' ),
			'update_item' => _x( 'Update Services Tag', 'att' ),
			'add_new_item' => _x( 'Add New Services Tag', 'att' ),
			'new_item_name' => _x( 'New Services Tag Name', 'att' ),
			'separate_items_with_commas' => _x( 'Separate services tags with commas', 'att' ),
			'add_or_remove_items' => _x( 'Add or remove services tags', 'att' ),
			'choose_from_most_used' => _x( 'Choose from the most used services tags', 'att' ),
			'menu_name' => _x( 'Services Tags', 'att' )
		);
	    ...
	    $taxonomy_services_category_labels = array(
			'name' => _x( 'Services Categories', 'att' ),
			'singular_name' => _x( 'Services Category', 'att' ),
			'search_items' => _x( 'Search Services Categories', 'att' ),
			'popular_items' => _x( 'Popular Services Categories', 'att' ),
			'all_items' => _x( 'All Services Categories', 'att' ),
			'parent_item' => _x( 'Parent Services Category', 'att' ),
			'parent_item_colon' => _x( 'Parent Services Category:', 'att' ),
			'edit_item' => _x( 'Edit Services Category', 'att' ),
			'update_item' => _x( 'Update Services Category', 'att' ),
			'add_new_item' => _x( 'Add New Services Category', 'att' ),
			'new_item_name' => _x( 'New Services Category Name', 'att' ),
			'separate_items_with_commas' => _x( 'Separate services categories with commas', 'att' ),
			'add_or_remove_items' => _x( 'Add or remove services categories', 'att' ),
			'choose_from_most_used' => _x( 'Choose from the most used services categories', 'att' ),
			'menu_name' => _x( 'Services Categories', 'att' ),
	    );
...
new Authentic_Services_Post_Type;
