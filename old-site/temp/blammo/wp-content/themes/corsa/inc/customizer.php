...
function wr_corsa_theme_options( $wp_customize = null ) {
	...
	$theme_options['footer'] = array(
		'title'       => __( 'Footer', 'corsa' ),
		'description' => __( 'Config for display text on footer and set the URLs for your social media profiles here to be used in the header. Adding in a link will make its respective icon show up without needing to do anything else.', 'corsa' ),
		'priority'    => 80,
		'settings'    => array(
		...
		'controls' => array(
			'wr_social_facebook' => array(
				'label'    => __( 'Facebook', 'corsa' ),
				'section'  => 'footer',
				'priority' => 3,
				'type'     => 'text',
			),
			'wr_social_twitter' => array(
				'label'    => __( 'Twitter', 'corsa' ),
				'section'  => 'footer',
				'priority' => 4,
				'type'     => 'text',
			),
			'wr_social_google-plus' => array(
				'label'    => __( 'Google Plus', 'corsa' ),
				'section'  => 'footer',
				'priority' => 5,
				'type'     => 'text',
			),
			'wr_social_linkedin' => array(
				'label'    => __( 'LinkedIn', 'corsa' ),
				'section'  => 'footer',
				'priority' => 6,
				'type'     => 'text',
			),			
			'wr_social_tumblr' => array(
				'label'    => __( 'Tumblr', 'corsa' ),
				'section'  => 'footer',
				'priority' => 7,
				'type'     => 'text',
			)
	...
	$theme_options['extras'] = array(
		...
		'controls' => array(
			...
			'wr_code_css' => array(
				'label'       => __( 'CSS', 'corsa' ),
				'description' => __( 'Do not place any &lt;style&gt; tags in these areas as they are already added for your convenience', 'corsa' ),
				'section'     => 'extras',
				'type'        => 'textarea',
				'priority'    => 6,
			),
			'wr_code_js' => array(
				'label'       => __( 'JavaScript', 'corsa' ),
				'description' => __( 'Do not place any &lt;script&gt; tags in these areas as they are already added for your convenience', 'corsa' ),
				'section'     => 'extras',
				'type'        => 'textarea',
				'priority'    => 7,
			)
...
function wr_corsa_customizer_control_js() {
	...
	wp_enqueue_script( 'corsa-customizer-control', get_template_directory_uri() . '/assets/js/customizer-control.js', array( 'jquery', 'customize-controls' ), '', true );
